...
@Author:Nanda Kishore Reddy Thineti
@Description:
...
class commandManager(parserManager):
    ...
    def ls_f(dir):
        ...
        for filename in filenames:
            ...
            files.append(time.strftime('%b:%d:%Y %H:%M:%S', time.localtime(os.path.getatime(path))))
            files.append(time.strftime('%b:%d:%Y %H:%M:%S', time.localtime(os.path.getmtime(path))))
            files.append(time.strftime('%b:%d:%Y %H:%M:%S', time.localtime(os.path.getctime(path))))
    ...
    def history(self):
        ...
        for history in open('/home/thinetin/.bash_history'):
            print(history, end='')
"""
@Name: driver
@Description:
